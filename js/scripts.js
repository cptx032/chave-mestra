  ...
  {  
    ...
    .then(function (mediaStream)
    {
      ...
      async function predict() 
      {
        ...
        {
          if (classPredict == "leftC" && parseFloat(valuePredict) >0.85)  //Seta esquerda
          ...
          if(classPredict == "rightC" && parseFloat(valuePredict) >0.85) //Seta direita 
          ...
          if(classPredict == "upC" && parseFloat(valuePredict) >0.85) //Seta cima
